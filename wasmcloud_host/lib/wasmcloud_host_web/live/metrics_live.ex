                    ...
                    <div class="row">
                        ...
                        <div class="card text-white bg-gradient-info">
                          <div class="card-body">
                            ...
                            <div class="text-value-lg">
                              <%= {{:input, num}, _out} = :erlang.statistics(:io); num / 1_000_000 |> Float.round(2)%> MB
                            </div>
                      ...
                      <div class="col-sm-6 col-md-2">
                        <div class="card text-white bg-gradient-success">
                          <div class="card-body">
                            ...
                            <div class="text-value-lg">
                              <%= {_input, {:output, num}} = :erlang.statistics(:io); num / 1_000_000 |> Float.round(2)%> MB
                            </div>
                      ...
                      <div class="col-sm-6 col-md-2">
                        <div class="card text-white bg-gradient-warning">
                          <div class="card-body">
                            ...
                            <div class="text-value-lg"><%= processes = :erlang.system_info(:process_count); processes %>
                            </div>
                      ...
                      <div class="col-sm-6 col-md-2">
                        <div class="card text-white bg-gradient-success">
                          <div class="card-body">
                            <div class="text-muted text-right mb-4">
                              <img class="c-icon c-icon-2xl" src="/images/wasmcloud_inversed_square.png"
                                alt="wasmCloud logo">
                            </div>
